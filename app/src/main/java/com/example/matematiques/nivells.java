...
public class nivells extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btnNivell1 = (Button) findViewById(R.id.btnlvl1);
        Button btnNivell2 = (Button) findViewById(R.id.btnlvl2);
        Button btnNivell3 = (Button) findViewById(R.id.btnlvl3);
        Button btnTornar = (Button) findViewById(R.id.tornarInici);
